...
public class C_Sharp_Adv extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        super.onCreate(savedInstanceState);
        strings=getResources().getStringArray(R.array.c_sharp_adv_topic);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(new Basic_Adv_Frag_Recycler_Adapter(getActivity(),strings,"C_SHARP_ADV"));

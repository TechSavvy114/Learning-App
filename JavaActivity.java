...
public class JavaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout=findViewById(R.id.tab_java);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 1) {
                    tabLayout.setBackgroundColor(ContextCompat.getColor(JavaActivity.this,
                            R.color.java));
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        getWindow().setStatusBarColor(ContextCompat.getColor(JavaActivity.this,
                                R.color.java));
                    }
                    toolbar.setBackgroundColor(ContextCompat.getColor(JavaActivity.this,
                            R.color.java));
